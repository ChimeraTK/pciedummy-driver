...
PACKAGE_FILES_WILDCARDS="mtcadummy-dkms*.deb mtcadummy-dkms*.changes"
PACKAGE_DEB_WILDCARDS="mtcadummy-dkms*.deb"
...
for REPO in intern pub; do
	...
	/export/reprepro/${REPO}/doocs remove ${DEBIAN_CODENAME} mtcadummy-dkms
done
